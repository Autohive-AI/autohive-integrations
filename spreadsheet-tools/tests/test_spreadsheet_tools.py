...
class TestConvertToJson:
    ...
    async def test_simple_csv_conversion(self):
        ...
        inputs = {"file": {"content": encode_file(file_bytes), "name": "test.csv", "contentType": "text/csv"}}
    ...
    async def test_excel_conversion(self):
        ...
        data = [["Alice", 28, "Seattle"], ["Charlie", 32, "Boston"], ["Diana", 29, "Austin"]]
    ...
    async def test_headers_with_special_characters(self):
        ...
        inputs = {"file": {"content": encode_file(file_bytes), "name": "test_special.csv", "contentType": "text/csv"}}
    ...
    async def test_duplicate_headers(self):
        ...
        inputs = {"file": {"content": encode_file(file_bytes), "name": "duplicates.csv", "contentType": "text/csv"}}
    ...
    async def test_empty_headers(self):
        ...
        inputs = {"file": {"content": encode_file(file_bytes), "name": "empty_headers.csv", "contentType": "text/csv"}}
    ...
    async def test_numeric_headers(self):
        ...
        inputs = {"file": {"content": encode_file(file_bytes), "name": "numeric.csv", "contentType": "text/csv"}}
    ...
    async def test_null_values(self):
        ...
        inputs = {"file": {"content": encode_file(file_bytes), "name": "nulls.csv", "contentType": "text/csv"}}
    ...
    async def test_multiple_rows(self):
        ...
        inputs = {"file": {"content": encode_file(file_bytes), "name": "large.csv", "contentType": "text/csv"}}
    ...
    async def test_invalid_file_content(self):
        ...
        inputs = {"file": {"content": encode_file(invalid_content), "name": "invalid.csv", "contentType": "text/csv"}}
    ...
    async def test_invalid_base64_encoding(self):
        ...
        inputs = {"file": {"content": "not-valid-base64!!!", "name": "test.csv", "contentType": "text/csv"}}
    ...
    async def test_missing_content(self):
        ...
        inputs = {"file": {"content": "", "name": "test.csv", "contentType": "text/csv"}}
    ...
    async def test_output_filename_generation(self):
        ...
        for input_name, expected_name in test_cases:
            inputs = {"file": {"content": encode_file(file_bytes), "name": input_name, "contentType": "text/csv"}}
