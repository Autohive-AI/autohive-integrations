    ...
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        parse_error = (
                            f"Unable to parse file as spreadsheet. Supported formats: Excel (.xlsx, .xls), "
                            f"CSV (.csv). Error: {str(e)}"
                        )
        ...
        if headers is None or data_rows is None:
            if parse_error:
                ...
                raise ValueError(
                    "Failed to parse file as a spreadsheet. The file may not contain valid spreadsheet data."
                )
