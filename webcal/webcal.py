...
class FetchEvents(ActionHandler):
    ...
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        ...
        # Return the events
        return ActionResult(data={"timezone": timezone_str, "events": events, "result": True}, cost_usd=0.0)
...
class SearchEvents(ActionHandler):
    ...
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        ...
        return ActionResult(
            data={"timezone": timezone_str, "search_term": search_term, "events": events, "result": True}, cost_usd=0.0
        )
