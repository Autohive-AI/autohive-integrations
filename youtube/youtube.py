...
class GetVideo(ActionHandler):
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        try:
            ...
            return ActionResult(
                data={"video": {}, "result": False, "error": str(e)}, cost_usd=0.0
            )
...
class UpdateVideo(ActionHandler):
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        try:
            ...
            return ActionResult(
                data={"video": YouTubeParser.parse_video(response), "result": True},
                cost_usd=0.0,
            )
...
class UploadThumbnail(ActionHandler):
    ...
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        try:
            ...
            return ActionResult(
                data={"thumbnail": {}, "result": False, "error": str(e)}, cost_usd=0.0
            )
...
class GetChannel(ActionHandler):
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        try:
            ...
            return ActionResult(
                data={"channel": {}, "result": False, "error": str(e)}, cost_usd=0.0
            )
...
class ListPlaylists(ActionHandler):
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        try:
            ...
            return ActionResult(
                data={"playlists": [], "result": False, "error": str(e)}, cost_usd=0.0
            )
...
class CreatePlaylist(ActionHandler):
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        try:
            ...
            return ActionResult(
                data={"playlist": {}, "result": False, "error": str(e)}, cost_usd=0.0
            )
...
class AddVideoToPlaylist(ActionHandler):
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        try:
            ...
            return ActionResult(
                data={"playlist_item": response, "result": True}, cost_usd=0.0
            )

        except Exception as e:
            return ActionResult(
                data={"playlist_item": {}, "result": False, "error": str(e)},
                cost_usd=0.0,
            )
...
class ListCommentReplies(ActionHandler):
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        try:
            ...
            return ActionResult(
                data={"replies": [], "result": False, "error": str(e)}, cost_usd=0.0
            )
...
class PostComment(ActionHandler):
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        try:
            ...
            return ActionResult(
                data={"comment": YouTubeParser.parse_comment(response), "result": True},
                cost_usd=0.0,
            )
