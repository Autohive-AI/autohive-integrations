...
class ListMeetingsAction(ActionHandler):
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        ...
        try:
            ...
            return ActionResult(data={"limit": 0, "next_cursor": None, "items": [], "error": str(e)}, cost_usd=0.0)
...
class GetTranscriptAction(ActionHandler):
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        ...
        try:
            ...
            return ActionResult(data={"recording_id": recording_id, "transcript": transcript}, cost_usd=0.0)
        except Exception as e:
            return ActionResult(data={"recording_id": recording_id, "transcript": [], "error": str(e)}, cost_usd=0.0)
...
class ListTeamsAction(ActionHandler):
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        ...
        try:
            ...
            return ActionResult(data={"limit": None, "next_cursor": None, "teams": [], "error": str(e)}, cost_usd=0.0)
...
class ListTeamMembersAction(ActionHandler):
    async def execute(self, inputs: Dict[str, Any], context: ExecutionContext):
        ...
        try:
            ...
            return ActionResult(
                data={"limit": None, "next_cursor": None, "team_members": [], "error": str(e)}, cost_usd=0.0
            )
