...
[code-analysis](code-analysis): Python code execution integration for data analysis, file processing, and automation tasks. Supports executing arbitrary Python code in a sandboxed environment, processing input files (CSV, Excel, JSON, images, PDFs), and automatically detecting and returning generated output files with base64 encoding. Pre-installed libraries include numpy, Pillow, pypdf, python-docx, reportlab, openpyxl, XlsxWriter, matplotlib, and python-pptx. Features ActionResult return type for cost tracking. No authentication required. Includes 1 action. Ideal for data transformation, document generation, chart creation, and custom automation workflows.
