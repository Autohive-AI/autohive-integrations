...
async def test_search_apps_ios():
    ...
    auth = {"api_key": "your_serpapi_key_here"}

    inputs = {"term": "WhatsApp", "country": "us", "num": 5}
...
async def test_get_reviews_app_store_by_name():
    ...
    inputs = {"app_name": "Instagram", "country": "us", "sort": "mostfavorable", "max_pages": 1}
...
async def test_search_places_google_maps():
    ...
    inputs = {"query": "Pizza restaurant", "location": "San Francisco, CA", "num_results": 5}
