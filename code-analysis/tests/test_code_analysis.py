...
class TestExecutePythonCodeAction(unittest.IsolatedAsyncioTestCase):
    async def test_simple_print(self):
        ...
        inputs = {"python_code": "print('Hello, World!')"}
...
print(len(lines))
""",
            "files": [{"name": "input.txt", "content": encoded_content, "contentType": "text/plain"}],
        }
    ...
    async def test_error_handling(self):
        ...
        inputs = {"python_code": "raise ValueError('Test error')"}
